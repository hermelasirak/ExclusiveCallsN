        ...
        <Container className="max-w-6xl mx-auto h-full px-4">
            ...
            <div className="h-full flex flex-col justify-start items-center pt-24">
                ...
                <div className="text-center max-w-4xl mx-auto mb-12">
                    ...
                    That’s where we come in. In 12 minutes of speaking to a team member
                ...
                ">
                    <CardContent className="w-full">
                        ...
                        <p className="text-center text-white mb-8 opacity-90">
                            Fill the form to request a call from us and we’ll get back to you shortly.
                        </p>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <Card className='h-32 overflow-y-auto w-full max-w-3xl rounded-3xl p-6 md:p-10 
                                    backdrop-blur-xl bg-black/40 border border-white/20 shadow-2xl'>
                                <CardContent>
                                        ...
                                        <ol>
                                            <li>
                                                ...
                                                <span className='flex gap-1 items-center'>
                                                    <Checkbox id='terms' className=' w-3 h-3'>
                                                        I consent to receive customer care or informational
                                                        messages related to my service requests.
                                                    </Checkbox>
                                                </span>
                                                <p>
                                            ...
                                            <li>
                                                ...
                                                <ul>
                                                    ...
                                                    For more details {" "}
                                                    <Link to='/privacypolicy' className='text-orange-400'>
