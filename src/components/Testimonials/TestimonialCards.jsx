...
const TestimonialCards = () => {
  return (
    // ⭐ CHANGE – section wrapper with light background & vertical padding
    <section className="w-full bg-[#f5f7fb] py-16 md:py-20 lg:py-24">
      <Container className="h-full flex flex-col items-center">
        <div className="w-full max-w-6xl">
          {/* ⭐ CHANGE – heading block centered, blue heading, grey subtitle */}
          <div className="flex flex-col justify-center items-center md:text-center mt-2 mx-auto gap-3 md:gap-4">
            ...
            <div className="max-w-[900px] mb-2">
              <h1 className="scroll-m-20 text-3xl md:text-5xl lg:text-6xl text-[#0843a1] font-extrabold">
                What Our Clients Say
              </h1>
            </div>
            <div className="max-w-screen-md">
              <p className="text-sm md:text-base lg:text-lg text-slate-600">
                Don&apos;t just take our word for it. Here&apos;s what sales
                leaders have to say about working with us.
              </p>
            </div>
          </div>

          {/* ⭐ CHANGE – responsive grid, no fixed card width/height */}
